...
def get_consonants() -> List[Consonant]:
    return [
        ...
        Consonant(
            "t", ConsonantManner("stop"), ConsonantPlace("alveolar-central"), False
        ),
        Consonant(
            "d", ConsonantManner("stop"), ConsonantPlace("alveolar-central"), True
        ),
        ...
        Consonant(
            "s", ConsonantManner("fricative"), ConsonantPlace("alveolar-central"), False
        ),
        Consonant(
            "z", ConsonantManner("fricative"), ConsonantPlace("alveolar-central"), True
        ),
        Consonant(
            "ɬ", ConsonantManner("fricative"), ConsonantPlace("alveolar-lateral"), False
        ),
        Consonant(
            "ɮ", ConsonantManner("fricative"), ConsonantPlace("alveolar-lateral"), True
        ),
        Consonant(
            "ʂ", ConsonantManner("fricative"), ConsonantPlace("retroflex"), False
        ),
        ...
        Consonant(
            "ʃ", ConsonantManner("fricative"), ConsonantPlace("post-alveolar"), False
        ),
        Consonant(
            "ʒ", ConsonantManner("fricative"), ConsonantPlace("post-alveolar"), True
        ),
        ...
        Consonant(
            "ħ", ConsonantManner("fricative"), ConsonantPlace("pharyngeal"), False
        ),
        Consonant(
            "ʕ", ConsonantManner("fricative"), ConsonantPlace("pharyngeal"), True
        ),
        ...
        Consonant(
            "Ts",
            ConsonantManner("affricate"),
            ConsonantPlace("alveolar-central"),
            False,
        ),
        Consonant(
            "dz", ConsonantManner("affricate"), ConsonantPlace("alveolar-central"), True
        ),
        Consonant(
            "tɬ",
            ConsonantManner("affricate"),
            ConsonantPlace("alveolar-lateral"),
            False,
        ),
        Consonant(
            "dɮ", ConsonantManner("affricate"), ConsonantPlace("alveolar-lateral"), True
        ),
        Consonant(
            "t̪ʂ", ConsonantManner("affricate"), ConsonantPlace("retroflex"), False
        ),
        Consonant(
            "d̪ʐ", ConsonantManner("affricate"), ConsonantPlace("retroflex"), True
        ),
        ...
        Consonant(
            "n̥", ConsonantManner("nasal"), ConsonantPlace("alveolar-central"), False
        ),
        Consonant(
            "n", ConsonantManner("nasal"), ConsonantPlace("alveolar-central"), True
        ),
        ...
        # Resonants > Liquids
        Consonant(
            "ɾ̥", ConsonantManner("liquid"), ConsonantPlace("alveolar-central"), False
        ),
        Consonant(
            "ɾ", ConsonantManner("liquid"), ConsonantPlace("alveolar-central"), True
        ),
        Consonant(
            "l", ConsonantManner("liquid"), ConsonantPlace("alveolar-lateral"), True
        ),
        Consonant("ɻ", ConsonantManner("liquid"), ConsonantPlace("retroflex"), True),
        Consonant(
            "j", ConsonantManner("liquid"), ConsonantPlace("post-alveolar"), True
        ),
